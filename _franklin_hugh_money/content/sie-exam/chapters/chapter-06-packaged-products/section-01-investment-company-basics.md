...
- Understand how shares are issued and redeemed for each type
...
<div class="historical-note">
  ...
  <p>The 1929 crash exposed serious problems with pooled investments of the era. Many were highly leveraged, charged excessive fees, and lacked transparency. The Investment Company Act of 1940 addressed these issues by requiring registration, disclosure, and operational standards.</p>
</div>
...
- <span class="key-term">Variable Annuities</span> are the primary example
...
<div class="test-tip">
  <p><strong>Test Tip:</strong> The exam loves to test the differences between open-end and closed-end funds. Remember: open-end = continuous issuance and redemption at NAV; closed-end = one-time issuance, trades on exchange, can trade at premium or discount.</p>
</div>
...
- Questions comparing open-end vs. closed-end fund characteristics
- Scenarios asking which type of fund trades at premiums/discounts
- Questions about UIT structure and termination
...
- Proceed to Section 6.2: Fund Management & Structure
- Review the 75-5-10 diversification rule
