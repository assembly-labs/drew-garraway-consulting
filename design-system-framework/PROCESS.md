...
- Create content strategy (voice, tone, messaging)
- Sketch wireframes
...
- [ ] Content strategy exists (voice, tone, key messages)
...
If you're starting a new project, proceed to `01-concept/SOP.md`.
