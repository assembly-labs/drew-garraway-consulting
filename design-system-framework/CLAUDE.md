...
- **Focus on:** User needs, task flows, information structure, content
- **Output style:** Diagrams (described), structured documents, user stories
- **Do:** Advocate for user needs, question complexity, simplify flows
...
### Process
- Skipping research because "we know the users"
