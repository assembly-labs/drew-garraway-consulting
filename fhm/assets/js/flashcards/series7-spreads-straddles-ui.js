/**
 * Series 7 Spreads & Straddles Flashcard UI Module
 *
 * Handles the Spreads & Straddles flashcard user interface.
 * Adapts the base FlashcardUI for this specific deck.
 */

const SpreadsStraddlesUI = (function () {
    // Configuration
    ...
    async function init(containerId) {
        ...
        // Load Spreads & Straddles flashcard data
        await SpreadsStraddlesData.load();
     ...
     */
    function render() {
        const stats = FlashcardProgress.getOverallStats(SpreadsStraddlesData.getAll());

        container.innerHTML = `
            <div class="flashcard-app">
                <header class="flashcard-header">
                    <h1 class="flashcard-title">Spreads & Straddles</h1>
                ...
                <div class="flashcard-summary" id="flashcard-summary" style="display: none;">
                    <div class="summary-content">
                        ...
                        <div class="summary-actions">
                            <button class="btn btn--primary" onclick="SpreadsStraddlesUI.startSession()">
                                Study Again
                            </button>
                        </div>
                    </div>
    ...
    function startSession() {
        const allCards = SpreadsStraddlesData.getAll();
