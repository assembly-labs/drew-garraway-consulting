...
- A sales pitch (nothing to sell)

---

## Method

The investment strategy employed here would disappoint anyone seeking excitement:

1. **Live below my means** - Spend less than I earn, revolutionary concept
...
- **My future self** - To remember why I made certain decisions
- **The curious** - Who wonder what patient investing actually looks like
- **The skeptical** - Who think the system is rigged (it partly is)
- **Fellow travelers** - On their own journey to financial independence

---

## Tone

The writing here aims to be:

- **Clear** - Financial concepts without the jargon
- **Honest** - Including the failures and doubts
- **Occasionally amusing** - Because compound interest alone is rather dry
- **Never preachy** - Everyone's situation differs
...
- **Years to independence** - The motivating metric
