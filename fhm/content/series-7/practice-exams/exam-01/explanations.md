...
### Question 7 - Answer: C ($54)

**Breakeven for long call = Strike + Premium**

Breakeven = $50 + $4 = **$54**

The stock must rise above $54 for the investor to profit after accounting for the premium paid.

---

### Question 8 - Answer: B ($500 loss)

**Short put calculation:**

- Premium received: $3 × 100 = $300
- Stock at expiration: $32 (below $40 strike)
- Put is exercised: Must buy at $40, stock worth $32
- Loss on stock: ($40 - $32) × 100 = $800
- Net result: $300 - $800 = **-$500 (loss)**
...
**Bull call spread with max gain of $700**

- Buy lower strike call ($60 at $5) = bullish
- Sell higher strike call ($70 at $2) = limit upside
- Net debit: $5 - $2 = $3 (max loss = $300)
- Max gain: ($70 - $60) - $3 = $7 × 100 = **$700**
...
### Question 13 - Answer: B (6.62%)

**Tax-equivalent yield = Municipal yield ÷ (1 - tax bracket)**

TEY = 4.5% ÷ (1 - 0.32) = 4.5% ÷ 0.68 = **6.62%**

---

### Question 14 - Answer: C

**Not do business with the issuer for 2 years**

G-37 is the "pay-to-play" rule. Contributions create a 2-year ban from business with that issuer.

---

### Question 15 - Answer: B ($8,000)
...
### Question 17 - Answer: B ($40.00)

**Margin call trigger = Debit ÷ (1 - maintenance %)**

Trigger = $30,000 ÷ 0.75 = **$40.00**

---

### Question 18 - Answer: B (5.71%)
...
For premium bonds: Nominal > Current > YTM

Memory aid: "Premium Decreases Yield"

---

### Question 21 - Answer: B ($19.00)
...
Roth contributions are after-tax, but qualified distributions are completely tax-free.
...
Buy limit orders are placed below market and execute at the limit price or better (lower).

Memory aid: **BLiSS** = Buy Limit is Set Below
...
Regular way settlement for stocks and bonds is T+1 as of 2024.
