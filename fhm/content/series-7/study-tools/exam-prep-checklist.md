...
- [ ] Confirm you have valid ID (must match exactly)
...
- [ ] Review your "weak spots" list one more time
...
- [ ] Watches or jewelry (may be restricted)
...
4. Receive scratch paper and pencil
...
- Max loss (buyer) = Premium
- Max gain (seller) = Premium

Margin:
- SMA buying power = SMA × 2
- Long trigger = Debit ÷ 0.75
- Short trigger = Credit ÷ 1.30
...
- **Check-in points**:
  - Question 45 = ~90 minutes in
  - Question 90 = ~180 minutes in
  - Save 30 minutes for review
...
- Stretch, use the bathroom, refocus

---

## If You Get Stuck

1. **Mark it and move on** - Don't spend 5 minutes on one question
2. **Eliminate wrong answers** - Even 50/50 is better than random
3. **Use common sense** - If an answer seems absurd, it probably is
4. **Remember key patterns**:
   - Buyers have rights, sellers have obligations
   - Reg T = 50%, maintenance = 25% long / 30% short
   - Premium bonds: yields decrease (N > C > YTM)
...
- Don't be discouraged—many people pass on the second attempt
...
- Focus on the questions you know, not the ones you don't
