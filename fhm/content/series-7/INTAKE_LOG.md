# Series 7 Screenshot Intake Log

Track all processed screenshots and their status through the pipeline.
...
| # | Screenshot Description | Section | Subsection | Status | Notes |
|---|------------------------|---------|------------|--------|-------|
| 1 | [description] | [1-4] | [if S3] | [status] | [notes] |
```
...
Ready to process screenshots. Send 1-3 images at a time with context about what they cover.
...
High-priority topics to process first (by exam weight):

1. **Options** (25-30%) - Section 3.04
2. **Municipal Bonds** (15-20%) - Section 3.03
3. **Margin Accounts** (10-15%) - Section 3.08
4. **Debt Securities** (10-12%) - Section 3.02
