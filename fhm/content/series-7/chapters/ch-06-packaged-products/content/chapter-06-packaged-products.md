...
<div class="comparison-table">
  <table>
    ...
    <tr>
      <td><strong>Face-amount certificate companies</strong></td>
      <td>An obsolete product; you need to know only that they are a type of investment company</td>
    </tr>
    <tr>
      <td><strong>Management companies</strong></td>
      <td>Open-end funds (mutual funds) and closed-end funds</td>
    </tr>
    <tr>
      <td><strong>Unit investment trusts (UITs)</strong></td>
      <td>Fixed portfolio; shares redeemable to issuer</td>
    </tr>
  </table>
</div>
...
<div class="critical-concept">
  ...
  <table>
    <tr>
      <th>Feature</th>
      <th>Open-End (Mutual Funds)</th>
      <th>Closed-End Funds</th>
    </tr>
    <tr>
      <td>Shares issued</td>
      <td>Unlimited (sold continuously)</td>
      <td>Fixed number (one-time issuance)</td>
    </tr>
    <tr>
      <td>Trading</td>
      <td>Redeemed by the fund at NAV</td>
      <td>Traded on exchange (supply/demand)</td>
    </tr>
    <tr>
      <td>Pricing</td>
      <td>NAV computed daily</td>
      <td>Market price (may differ from NAV)</td>
    </tr>
    <tr>
      <td>Trading at discount/premium</td>
      <td>No</td>
      <td>Yes</td>
    </tr>
  </table>
...
<div class="info-box">
  ...
  <ul>
    <li>UITs issue <span class="key-term">shares of beneficial interest</span> representing an undivided interest in a unit of the trust's portfolio</li>
    <li>Like mutual funds, a prospectus must be provided at or prior to an offer or sale</li>
    <li>UITs have a stated termination date that varies according to the type of investments in the portfolio</li>
    <li>Fixed UITs: Equity UITs typically mature in 15 months. Bond UITs are longer, terminating in 20 or 25 years.</li>
    <li>Units are typically redeemable, similar to a mutual fund</li>
  </ul>
</div>
...
## Section 2: Management Company Basics (Mutual Funds)
...
<div class="info-box">
  ...
  <ul>
    <li><strong>Investment adviser:</strong> Makes buy/sell decisions; largest expense</li>
    <li><strong>Board of directors:</strong> Oversees the fund; represents shareholders</li>
    <li><strong>Custodian:</strong> Holds the fund's securities and cash</li>
    <li><strong>Transfer agent:</strong> Processes purchases, redemptions, and recordkeeping</li>
  </ul>
</div>

### Topic 2: Benefits of Mutual Funds

- **Diversification:** Reduces unsystematic risk
- **Professional management:** Expert investment decisions
- **Liquidity:** Shares redeemable at NAV
- **Convenience:** Easy to buy and sell
- **Affordability:** Low minimum investments

### Topic 3: Types of Mutual Funds
...
<div class="comparison-table">
  <table>
    ...
    <tr>
      <td><strong>Growth funds</strong></td>
      <td>Invest in equity securities of rapidly growing companies to achieve capital gains</td>
    </tr>
    <tr>
      <td><strong>Growth and income funds</strong></td>
      <td>Invest in established blue chip companies (e.g., IBM or Clorox) that provide both dividend income and growth potential</td>
    </tr>
    <tr>
      <td><strong>Value funds</strong></td>
      <td>Invest in stocks that are deemed to be undervalued based on fundamental factors; these funds often pay dividends that are higher than those of growth funds</td>
    </tr>
    <tr>
      <td><strong>Income funds</strong></td>
      <td>Invest in fixed-income securities, such as preferred stock and bonds; may specialize in one type of fixed-income security</td>
    </tr>
    <tr>
      <td><strong>Balanced funds</strong></td>
      <td>Invest in different types of securities, maintaining a "balance" of equities and fixed-income securities; provide both income and capital gains potential</td>
    </tr>
    <tr>
      <td><strong>Index funds</strong></td>
      <td>Aim to replicate the performance of an index, such as the S&P 500</td>
    </tr>
    <tr>
      <td><strong>Specialized funds (sector)</strong></td>
      <td>Invest in a particular industry or geographic area (e.g., energy or emerging markets); offer less diversification but potentially higher growth</td>
    </tr>
    <tr>
      <td><strong>Target-date (lifecycle) funds</strong></td>
      <td>Popular with retirement investors; automatically shifts from aggressive (stocks) to conservative (bonds) as target date approaches</td>
    </tr>
    <tr>
      <td><strong>International funds</strong></td>
      <td>Invest exclusively outside of the U.S.; global funds include both U.S. and foreign issues</td>
    </tr>
  </table>
</div>
...
## Section 3: Buying and Selling Fund Shares
...
<div class="calculation-box">
  ...
  <div class="calculation-box__formula">NAV = (Total Assets - Liabilities) ÷ Shares Outstanding</div>
</div>
...
<div class="calculation-box">
  ...
  <div class="calculation-box__formula">NAV + Sales Charge = POP</div>
  <p>If the NAV is $9.50 and the sales charge is 5%, then:</p>
...
<div class="info-box">
  ...
  <p>Sales Charge Percentage = (POP - NAV) ÷ POP</p>
</div>
...
<div class="critical-concept">
  <div class="critical-concept__label">Ways to Reach Breakpoints</div>
  <ul>
    <li><strong>Combination privilege:</strong> Combine purchases of different funds within the same fund family</li>
    <li><strong>Rights of accumulation:</strong> Current holdings plus new purchases count toward breakpoint</li>
    <li><strong>Letter of intent (LOI):</strong> Commit to investing a certain amount over 13 months to receive breakpoint discount now</li>
  </ul>
</div>

---

## Section 4: Mutual Fund Expenses and Share Classes
...
<div class="comparison-table">
  <table>
    ...
    <tr>
      ...
      <td>Front-end load (upfront)</td>
      <td>Lower (or none)</td>
      <td>Large investments; long-term investors; accounts benefiting from breakpoints</td>
    </tr>
    <tr>
      <td><strong>Class B</strong></td>
      <td>Back-end load (CDSC)</td>
      <td>Higher</td>
      <td>Intermediate-term investments; smaller amounts (although B shares may convert to A shares if held long enough)</td>
    </tr>
    <tr>
      <td><strong>Class C</strong></td>
      <td>No front or back-end</td>
      <td>Higher</td>
      <td>Short-term investors (less than one year); smaller investors who don't plan to hold for a long time</td>
    </tr>
  </table>
</div>
...
- 2% if redeemed after 4 years
- 1% if redeemed after 5 years
- 0% if redeemed after 6 years
...
## Section 5: Fund Distributions and Prohibited Practices
...
<div class="critical-concept">
  <div class="critical-concept__label">Prohibited Practices</div>
  <ul>
    <li><strong>Breakpoint selling:</strong> Selling just below a breakpoint to deny the investor a discount</li>
    <li><strong>Switching:</strong> Moving client from one fund family to another without justification (generates new commissions)</li>
    <li><strong>Selling dividends:</strong> Encouraging purchase just before a distribution (investor pays taxes on the distribution)</li>
  </ul>
</div>

---

## Section 6: Other Packaged Products
...
<div class="comparison-table">
  <table>
    ...
    <tr>
      <td>Trading</td>
      <td>Throughout the day on exchange</td>
      <td>Once daily at closing NAV</td>
    </tr>
    <tr>
      <td>Pricing</td>
      <td>Market price (supply/demand)</td>
      <td>NAV</td>
    </tr>
    <tr>
      <td>Management</td>
      <td>Usually passive (index tracking)</td>
      <td>Active or passive</td>
    </tr>
    <tr>
      <td>Can be bought on margin</td>
      <td>Yes</td>
      <td>No</td>
    </tr>
    <tr>
      <td>Can be sold short</td>
      <td>Yes</td>
      <td>No</td>
    </tr>
    <tr>
      <td>Sales charges</td>
      <td>No (but brokerage commission)</td>
      <td>May have sales charges</td>
    </tr>
    <tr>
...
<div class="info-box">
  ...
  <ul>
    <li>Must distribute at least 90% of its income to shareholders</li>
    <li>At least 75% of the REIT's annual gross income must be real estate-related income (e.g., rents)</li>
    <li>At least 95% of the REIT's annual gross income must come from real estate-related income or dividends and income from other sources (e.g., stock market investments)</li>
    <li>At least 75% of total assets must be invested in real estate</li>
    <li>Must be managed by a board of directors or trustees</li>
...
<div class="comparison-table">
  <table>
    ...
    <tr>
      <td><strong>Private REITs</strong></td>
      <td>Exempt from SEC registration; typically offered only to institutional investors; limited or no liquidity</td>
    </tr>
    <tr>
      <td><strong>Registered non-listed REITs</strong></td>
      <td>Registered with SEC but do not trade on an exchange; lack liquidity because they cannot be traded</td>
    </tr>
    <tr>
      <td><strong>Listed REITs</strong></td>
      <td>Most familiar type; registered with SEC and trade on an exchange or over-the-counter; highly liquid</td>
    </tr>
  </table>
</div>
