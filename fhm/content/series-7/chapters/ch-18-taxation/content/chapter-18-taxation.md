...
<div class="historical-note">
  ...
  <p>The Internal Revenue Service is part of the Department of the Treasury. It collects taxes and enforces the Internal Revenue Code. But here's a distinction the exam tests: the IRS doesn't prosecute tax evaders. That's the Department of Justice. The IRS identifies and audits; the DOJ takes people to court.</p>
</div>
...
<div class="critical-concept">
  ...
  <p><strong>Earned income</strong> — salaries, wages, bonuses, tips, commissions. Subject to FICA taxes.<br>
  <strong>Portfolio (investment) income</strong> — dividends, interest, capital gains. NOT subject to FICA.<br>
...
<div class="info-box">
  ...
  <table>
    <tr><th>Holding Period</th><th>Classification</th><th>Tax Rate</th></tr>
    <tr><td>12 months or less</td><td>Short-term</td><td>Ordinary income rate</td></tr>
    <tr><td>More than 12 months</td><td>Long-term</td><td>0%, 15%, or 20% (depending on income)</td></tr>
  </table>
</div>
...
<div class="test-tip">
  <p><strong>Test Tip:</strong> Profits from short sales are always treated as <strong>short-term capital gains</strong>, regardless of how long the short position was held open.</p>
</div>
...
In a stock split, the total cost basis stays the same—only the per-share basis changes.

<div class="info-box">
  <div class="info-box__title">Real-World Example</div>
  <p>You own 100 shares at $100 each (total basis: $10,000). After a 2-for-1 split, you own 200 shares. Your total basis is still $10,000, but your per-share basis is now $50. In a 1-for-5 reverse split: 20 shares at $500 each. Same $10,000 total basis.</p>
</div>
...
<div class="critical-concept">
  <div class="critical-concept__label">MEMORIZE THIS</div>
  <p><strong>Expiration:</strong> Long position = capital loss (premium lost). Short position = capital gain (premium kept).<br>
  <strong>Closeout (traded):</strong> Gain or loss = difference between premiums paid and received.<br>
  <strong>Exercise:</strong> No immediate tax event. Premium is folded into the cost basis or sale proceeds of the underlying stock.</p>
</div>

### Options Tax Table

<div class="info-box">
  <div class="info-box__title">Capital Gains and Losses From Options</div>
  <table>
    <tr><th>Position</th><th>Closed Out</th><th>Expires</th><th>Exercised</th></tr>
    <tr><td><strong>Long Call</strong></td><td>Gain/loss on premiums</td><td>Loss = premium paid</td><td>Cost basis = strike + premium</td></tr>
    <tr><td><strong>Long Put</strong></td><td>Gain/loss on premiums</td><td>Loss = premium paid</td><td>Sale proceeds = strike - premium; cost basis = cost of underlying</td></tr>
    <tr><td><strong>Short Call</strong></td><td>Gain/loss on premiums</td><td>Gain = premium received</td><td>Sale proceeds = strike + premium; cost basis = cost of underlying</td></tr>
    <tr><td><strong>Short Put</strong></td><td>Gain/loss on premiums</td><td>Gain = premium received</td><td>Cost basis = strike - premium</td></tr>
  </table>
</div>
...
<div class="historical-note">
  <div class="historical-note__label">Historical Context</div>
  <p>The tax exemption for municipal bond interest dates back to the Supreme Court's 1895 ruling in <em>Pollock v. Farmers' Loan & Trust Co.</em>, which held that taxing state and local bond interest was equivalent to taxing the states themselves. Though the legal reasoning has evolved, the exemption has survived for over a century—making municipal bonds one of the most tax-advantaged investments available.</p>
</div>
...
<div class="critical-concept">
  <div class="critical-concept__label">MEMORIZE THIS</div>
  <table>
    <tr><th>Bond Type</th><th>Federal Tax?</th><th>State/Local Tax?</th></tr>
    <tr><td>Municipal</td><td>Exempt</td><td>Depends on residency</td></tr>
    <tr><td>Treasury</td><td>Taxable</td><td>Exempt</td></tr>
    <tr><td>Corporate</td><td>Taxable</td><td>Taxable</td></tr>
  </table>
</div>
...
<div class="calculation-box">
  ...
  <div class="calculation-box__formula">Net Yield = Coupon Rate &times; (1 &minus; Tax Rate)</div>
</div>

<div class="calculation-box">
  <div class="calculation-box__label">Taxable Equivalent Yield (What a Muni Would Need to Equal)</div>
  <div class="calculation-box__formula">Taxable Equivalent Yield = Municipal Coupon Rate &divide; (1 &minus; Tax Rate)</div>
</div>

<div class="info-box">
  <div class="info-box__title">Real-World Example</div>
  <p>An investor in the 30% tax bracket is comparing a 10% corporate bond to a 7% municipal bond.<br><br>
  Corporate net yield: 10% &times; (1 &minus; 0.30) = <strong>7%</strong><br>
  Municipal taxable equivalent yield: 7% &divide; (1 &minus; 0.30) = <strong>10%</strong><br><br>
  They're equivalent. But if the muni yields anything above 7%, it wins for this investor.</p>
</div>
...
3. **Redemption** — when the investor sells their fund shares

<div class="test-tip">
  <p><strong>Test Tip:</strong> Capital gains distributions are based on the <em>fund's</em> holding period, not the investor's. If the fund held a stock for 3 years before selling, the distribution is long-term for shareholders—even if the shareholder just bought the fund yesterday.</p>
</div>
...
<div class="info-box">
  <div class="info-box__title">Bond Fund Taxation</div>
  <table>
    <tr><th>Fund Type</th><th>Federal</th><th>State</th><th>Local</th></tr>
    <tr><td>Corporate bond fund</td><td>Yes</td><td>Yes</td><td>Yes</td></tr>
    <tr><td>Agency (GNMA/CMO) fund</td><td>Yes</td><td>Yes</td><td>Yes</td></tr>
    <tr><td>Treasury fund</td><td>Yes</td><td>No</td><td>No</td></tr>
    <tr><td>Municipal bond fund</td><td>No</td><td>Maybe*</td><td>Maybe*</td></tr>
  </table>
  <p>*Depends on whether the investor resides in the issuing state.</p>
</div>
...
<div class="info-box">
  <div class="info-box__title">Traditional IRA vs. Roth IRA</div>
  <table>
    <tr><th></th><th>Traditional IRA</th><th>Roth IRA</th></tr>
    <tr><td><strong>Contributions</strong></td><td>Pre-tax (tax-deductible)</td><td>After-tax (not deductible)</td></tr>
    <tr><td><strong>Growth</strong></td><td>Tax-deferred</td><td>Tax-free</td></tr>
    <tr><td><strong>Distributions</strong></td><td>Taxed as ordinary income</td><td>Tax-free (if qualified)</td></tr>
    <tr><td><strong>RMDs</strong></td><td>Required at age 73</td><td>None during owner's lifetime</td></tr>
    <tr><td><strong>Early withdrawal penalty</strong></td><td>10% + income tax</td><td>10% + tax on earnings only</td></tr>
  </table>
</div>

<div class="test-tip">
  <p><strong>Test Tip:</strong> Converting a Traditional IRA to a Roth triggers ordinary income tax on the converted amount—but there's no 10% early withdrawal penalty and no income limit on conversions.</p>
</div>
...
<div class="critical-concept">
  <div class="critical-concept__label">MEMORIZE THIS</div>
  <p>Income from limited partnerships is <strong>passive income</strong>. Passive losses can ONLY offset passive income—never earned income or portfolio income.<br><br>
  Exception: up to $25,000 of losses from <strong>active participation in real estate rental</strong> activities can offset other income.</p>
</div>
...
<div class="critical-concept">
  <div class="critical-concept__label">MEMORIZE THIS</div>
  <p>If you sell a security at a loss and buy the same or substantially identical security within <strong>30 days before or after</strong> the sale (61-day window total), the loss is <strong>disallowed</strong>. The disallowed loss is added to the cost basis of the replacement shares.</p>
</div>
...
<div class="info-box">
  <div class="info-box__title">Gift Tax Exclusions</div>
  <table>
    <tr><th></th><th>2024</th><th>2025</th><th>2026</th></tr>
    <tr><td><strong>Annual Gift Tax Exclusion</strong></td><td>$18,000</td><td>$19,000</td><td>$19,000</td></tr>
    <tr><td><strong>Lifetime Gift Tax Exclusion</strong></td><td>$13.61 Million</td><td>$13.99 Million</td><td>$13.99 Million</td></tr>
  </table>
</div>
...
<div class="critical-concept">
  ...
  <p><strong>Equity:</strong> Qualified dividends taxed at capital gains rate; stock splits/dividends not taxable; cost basis methods (FIFO, specific ID, average cost for funds)</p>
  <p><strong>Options:</strong> Expiration, closeout, exercise each have different tax treatment; married puts fold premium into cost basis; puts on short-term stock reset holding period</p>
  <p><strong>Bonds:</strong> Municipal = federal tax-free; Treasury = state tax-free; Corporate = fully taxable. Know net yield and taxable equivalent yield formulas. Premium amortized, discount accreted.</p>
  <p><strong>Mutual Funds:</strong> 90% distribution rule (Subchapter M); fund's holding period determines capital gains treatment; reinvested distributions are still taxable</p>
  <p><strong>Annuities/Retirement:</strong> Traditional IRA = pre-tax in, taxable out. Roth = after-tax in, tax-free out. 1035 exchange = tax-free annuity swap. 10% penalty before 59&frac12;</p>
  <p><strong>REITs/DPPs:</strong> Pass-through taxation; passive losses offset passive income only; $25K real estate exception; tax basis limits deductible losses</p>
  <p><strong>Other:</strong> Wash sale = 30-day rule; stepped-up basis on inherited securities; charitable donations of long-term stock = FMV deduction; AMT targets private activity bond interest</p>
</div>
