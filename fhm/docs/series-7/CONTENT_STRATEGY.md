...
Based on SIE patterns, each lesson follows this structure:

1. **Opening Hook** (1-2 paragraphs)
   - Story, historical context, or "why this matters"
...
3. **Core Content** (1,500-2,500 words)
   - 3-5 major sections
   - Clear hierarchy (H2 → H3 → H4)
   - Examples throughout
   - Visual elements (tables, boxes)

4. **Test Preparation** (200-300 words)
   - Key exam traps
   - Memory aids
   - Common mistakes

5. **Summary** (150-250 words)
   - Quick reference
   - Key terms list
...
## Quiz & Practice Question Strategy
...
1. **Concept Questions** (40%)
   - Test understanding of rules, definitions, characteristics
   - "Which of the following is TRUE about..."

2. **Scenario Questions** (35%)
   - Apply knowledge to customer situations
   - "An investor who wants income and safety should..."

3. **Calculation Questions** (25%)
   - Options max gain/loss/breakeven
   - Margin calculations
...
- Detailed explanation (FHM voice)

### Quiz Hierarchy

1. **Lesson Quizzes** - 5-10 questions after each lesson
2. **Chapter Quizzes** - 15-20 questions covering full chapter
3. **Section Quizzes** - 25-40 questions for each main section
4. **Comprehensive Exams** - 125 questions, full exam format
...
4. **Rule Cards** (20%)
   ```
   Front: "What is the Reg T initial margin requirement?"
   Back: "50% of purchase price. Customer pays 50%, broker loans 50%."
   ```

---

## Study Tools Strategy
...
2. **Options Calculations**
   - Max gain/loss for all positions
   - Breakeven points
   - Spread calculations

3. **Margin Calculations**
   - Long margin initial requirement
   - SMA and buying power
   - Maintenance margin
   - Margin call calculations
   - Short margin calculations
...
- Reading errors (missing "EXCEPT" or "NOT")
...
Apply FHM brand voice:

1. **Write opening hook** - Story or "why it matters"
2. **Add historical context** - Why does this rule exist?
3. **Include real examples** - Concrete numbers and scenarios
4. **Insert one humor moment** - Per section, no more
...
- Add practice question references
...
- [ ] All calculations have step-by-step examples
...
## Calculation Content Strategy

### Priority Calculation Topics

These require dedicated calculation worksheets:

1. **Options (Highest Priority)**
   - Max gain/loss for all 4 basic positions
   - Breakeven points
   - Spread net premium
   - Spread max gain/loss/breakeven
   - Straddle calculations

2. **Margin (High Priority)**
   - Initial margin requirement
   - Loan value
   - SMA calculations
   - Maintenance margin
   - Margin call trigger
   - Short margin (special requirements)

3. **Bonds (Medium Priority)**
   - Current yield
   - Tax-equivalent yield
   - Accrued interest

4. **Funds (Lower Priority)**
   - NAV calculation
   - Sales charge percentage

### Calculation Presentation Format

Each calculation lesson includes:

1. **The Formula** - Clear, boxed
2. **What Each Variable Means** - Plain English
3. **Step-by-Step Example** - Full walkthrough
4. **Common Mistakes** - What to avoid
5. **Practice Problems** - 5-10 with answers
6. **Memory Trick** - When helpful
...
- All lessons pass transformation checklist
- Historical context in every major topic
- Calculations have worked examples
- Humor is present but subtle

### Content Coverage

- 100% of FINRA content outline addressed
- Proportional depth matches exam weights
- All calculation types have dedicated practice

### User Experience

- Clear navigation between topics
- Obvious study progression
- Progress tracking visible
- Quick access to formulas
...
```
Foundation Layer:
├── Securities basics (stock, bond definitions)
├── Account types
└── Order types

Second Layer:
├── Options basics ← needs securities foundation
├── Bond pricing ← needs bond basics
└── Margin basics ← needs account types

Third Layer:
├── Options strategies ← needs options basics
├── Spread calculations ← needs options strategies
├── SMA/Buying power ← needs margin basics
└── Muni trading ← needs muni fundamentals

Fourth Layer:
├── Advanced options ← needs strategies
├── Combined accounts ← needs long + short margin
└── MSRB rules ← needs muni trading
```

**Implication:** Content should be created in this order to allow cross-referencing.
