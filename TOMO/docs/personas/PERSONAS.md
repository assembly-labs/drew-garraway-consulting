# TOMO User Personas - Consolidated 2026-02-05

> **Purpose**: This consolidated document combines user research personas with implementation-ready test profiles. It defines who we're building for, their psychology, and the mock data used for development/testing.
>
...
1. **User Personas & Research** - Who we're building for, their psychology, messaging guidelines
2. **Test Persona Profiles** - 6 detailed implementation profiles with mock data for development
3. **Cross-Reference Tables** - Quick lookups for risk signals, content tone, metrics

---

# PART 1: USER PERSONAS & RESEARCH
...
# PART 2: TEST PERSONA PROFILES (IMPLEMENTATION)
...
The Settings component should offer a dropdown to select any of the 6 test personas:
...
| Coach-athlete relationship | B=0.556 | Strong predictor of performance |
...
*Source files archived in `_archived/`*
