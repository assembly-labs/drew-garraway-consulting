...
import { getWeekBounds, toDateString } from '../services/insights-engine';
import type {
  Insight,
  InsightType,
  WeeklyInsightOutput,
...
// ===========================================
// PRE-INSIGHT LIMITATION + QUOTE (Mode A)
// Shows state-aware limitation message, then a fresh motivational quote.
// ===========================================
