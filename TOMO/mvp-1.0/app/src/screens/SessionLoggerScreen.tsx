...
import { insightService, insightGenerationService } from '../services/insights-service';
import { buildWeeklyInput, getWeekBounds, type ProfileContext } from '../services/insights-engine';
...
async function maybeTriggerWeeklyInsight(profile: Profile | null): Promise<void> {
  if (!profile) return;
...
type Phase = 'entry' | 'recording' | 'processing' | 'review';
...
export function SessionLoggerScreen() {
  ...
  const handleSave = useCallback(async () => {
    ...
    try {
      ...
      maybeTriggerWeeklyInsight(profile).catch(() => {});
