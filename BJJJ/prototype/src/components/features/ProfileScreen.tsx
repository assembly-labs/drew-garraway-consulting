    ...
    <div style={{
      ...
      <div className="card" style={{ textAlign: 'center' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            border: profile.belt === 'white' ? '1px solid #CCC' : 'none',
            borderRadius: 2,
          }} />
      ...
      >
        <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-md)' }}>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--color-gray-600)" strokeWidth="2">
          ...
          <div>
            <div style={{ fontWeight: 600, color: 'var(--color-gray-800)' }}>Settings</div>
            <div style={{ fontSize: 'var(--text-sm)', color: 'var(--color-gray-500)' }}>
