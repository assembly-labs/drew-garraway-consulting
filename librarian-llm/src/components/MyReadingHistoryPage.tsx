          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
            ...
            {showPrivacyInfo && (
              <div className="mt-4 space-y-4 text-sm text-gray-600 dark:text-gray-400">
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Reading History</h4>
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 dark:text-gray-100 mb-2">Privacy Options</h4>
